...
use App\Filament\Resources\Game\Punishment\BanResource\Pages;
use App\Filament\Resources\Game\Punishment\BanResource\RelationManagers;
...
class BanResource extends Resource
{
    ...
    {
        return "Ban-" . $record->punishment_id;
    }
