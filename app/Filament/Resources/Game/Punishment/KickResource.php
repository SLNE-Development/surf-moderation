...
use App\Filament\Resources\Game\Punishment\KickResource\Pages;
use App\Filament\Resources\Game\Punishment\KickResource\RelationManagers;
...
class KickResource extends Resource
{
    protected static ?string $model = Kick::class;
    ...
    {
        return "Kick-" . $record->punishment_id;
    }
    ...
    {
        return [
            'index' => Pages\ListKicks::route('/'),
            'view' => Pages\ViewKick::route('/{record}'),
//            'create' => Pages\CreateKick::route('/create'),
            'edit' => Pages\EditKick::route('/{record}/edit'),
        ];
    }

    public static function getNavigationBadge(): ?string
    {
        return Kick::query()->count();
    }
}
