...
use App\Filament\Resources\Game\Punishment\MuteResource\Pages;
use App\Filament\Resources\Game\Punishment\MuteResource\RelationManagers;
...
class MuteResource extends Resource
{
    ...
    {
        return "Warn-" . $record->punishment_id;
    }
